/*
Doeppner, Operating Systems In Depth: Design and Programming:
http://bcs.wiley.com/he-bcs/Books?action=resource&bcsId=6330&itemId=0471687235&resourceId=23714
*/
...
Node_t *
search(char *name, Node_t *parent, Node_t **parentpp) {
